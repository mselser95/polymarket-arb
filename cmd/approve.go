...
func runApprove(cmd *cobra.Command, args []string) error {
	...
	fmt.Printf("=== Approve USDC Spending ===\n\n")
	...
	if receipt.Status == 1 {
		...
		fmt.Printf("You can now place orders using:\n")
		fmt.Printf("  go run . place-orders <market-slug> --size 1.0 --yes-price 0.50 --no-price 0.50\n")
	} else {
